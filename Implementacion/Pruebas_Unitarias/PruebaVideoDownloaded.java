...
public class PruebaVideoDownloaded {
  ...
  @Test
  public void testVideoDownloaded() throws Exception {
    driver.get(baseUrl + "");
    Thread.sleep(3000);
    driver.findElement(By.cssSelector("input[type=\"file\"]")).clear();
    driver.findElement(By.cssSelector("input[type=\"file\"]")).sendKeys("C:\\Users\\jjime\\Documents\\Workspace\\Aseguramiento\\video.mp4");
