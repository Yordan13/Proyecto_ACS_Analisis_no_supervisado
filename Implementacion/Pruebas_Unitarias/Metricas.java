...
public class Metricas {
   ...
   * la funci�n pixelesPorSegundo de la clase UtilImagen.
   * 
  ...
  /**
   * Aplica el algoritmo de dice a todos los frames pertencientes a un video alojado en la direcci�n
   * o ubicaci�n que se indica por par�metro.
   * 
